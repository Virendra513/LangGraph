...
# make tool list
tools = [search_tool, random_float_range]

def invoke_model(messages: list[dict], model: str = "openai/gpt-oss-20b:groq", temperature: float = 0.7, max_tokens: int = 50, top_p: float = 0.9, tools: list = None):
    if not messages:
